...
SHARPEN = False
WHITE_FLOOR = 0.70    # luminance above this is forced to blank (space)
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">vruxak@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'vruxak@github:~$ whoami <tspan fill="{INK}">Vruxak Patel</tspan></text>')
parts.append(f'<rect x="{PAD+282}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
